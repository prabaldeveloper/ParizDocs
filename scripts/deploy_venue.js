...
async function main() {
    ...
    await venueContract.updateVenueFees(7, "200000000000");
    ...
    await venueContract.updateVenueFees(19, "700000000000")
    // await new Promise(res => setTimeout(res, 1000));
    ...
    await venueContract.updateVenueFees(31, "340000000000")
    ...
    await venueContract.updateVenueFees(33, "73500000000")
    // await new Promise(res => setTimeout(res, 1000));

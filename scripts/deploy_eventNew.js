...
async function main() {
    ...
    // local
    // const venueAddress = "0x135415452c114b55af6d113E482F423a50010106"
    // const conversionAddress = "0x73D335E12f0b887C65379c8D42F1c7b25Eca8Aef"
    ...
    // // await new Promise(res => setTimeout(res, 1000));
    await eventProxy.updateTreasuryContract(treasuryProxyAddress);
    ...
    // // // // //Buy Ticket
    // await new Promise(res => setTimeout(res, 3000));
    // await ticketMaster.buyTicket(1, Trace, "20000000000000");
    // console.log("Ticket Bought");

...
async function main() {
    ...
    const manageContract = "0xb8A839E6D70dAd03f08B9c5c9BD78d927C2D1759";
    ...
    // //const eventProxy = await eventContract.attach("0x114C01b9DD7077565b702D5c614Ed18E9970dfa3");
    ...
    // await treasuryProxy.grantAdmin(eventProxy);
    ...
    // let fee = await eventProxy.calculateRent(1, 1677746725, 1677833125);

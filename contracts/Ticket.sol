...
contract Ticket is TicketMetadata {
    function deployTicketNFTInternal(string memory _name, string memory _symbol, uint256 _totalSupply, uint256 _eventId, uint256[2] memory _time) public initializer {
